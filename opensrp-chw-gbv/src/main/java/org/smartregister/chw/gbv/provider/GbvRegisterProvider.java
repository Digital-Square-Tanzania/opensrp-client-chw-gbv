package org.smartregister.chw.gbv.provider;
...
public class GbvRegisterProvider implements RecyclerViewProvider<GbvRegisterProvider.RegisterViewHolder> {
    ...
    public GbvRegisterProvider(Context context, View.OnClickListener paginationClickListener, View.OnClickListener onClickListener, Set visibleColumns) {
    ...
    private String updateMemberGender(CommonPersonObjectClient commonPersonObjectClient) {
        ...
        return GbvUtil.getGenderTranslated(context, gender);
    ...
    private void populatePatientColumn(CommonPersonObjectClient pc, final RegisterViewHolder viewHolder) {
        try {
            ...
            viewHolder.patientColumn.setTag(R.id.VIEW_ID, BaseGbvRegisterFragment.CLICK_VIEW_NORMAL);

            viewHolder.dueButton.setTag(pc);
            viewHolder.dueButton.setTag(R.id.VIEW_ID, BaseGbvRegisterFragment.FOLLOW_UP_VISIT);
