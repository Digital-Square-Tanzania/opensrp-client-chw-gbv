...
import org.smartregister.chw.gbv.provider.GbvRegisterProvider;
...
public class BaseGbvRegisterFragment extends BaseRegisterFragment implements GbvRegisterFragmentContract.View {
    public static final String CLICK_VIEW_NORMAL = "click_view_normal";
    public static final String FOLLOW_UP_VISIT = "follow_up_visit";

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        GbvRegisterProvider gbvRegisterProvider = new GbvRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
        clientAdapter = new RecyclerViewPaginatedAdapter(null, gbvRegisterProvider, context().commonrepository(this.tablename));
    ...
    @Override
    public GbvRegisterFragmentContract.Presenter presenter() {
        return (GbvRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseGbvRegisterFragmentPresenter(this, new BaseGbvRegisterFragmentModel(), null);
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BaseGbvProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
