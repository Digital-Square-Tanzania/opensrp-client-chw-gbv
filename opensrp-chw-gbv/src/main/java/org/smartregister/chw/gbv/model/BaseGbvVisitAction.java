...
import org.smartregister.chw.gbv.fragment.BaseHomeVisitFragment;
 ...
 */
public class BaseGbvVisitAction {
    ...
    private BaseGbvVisitAction(Builder builder) throws ValidationException {
    ...
    public BaseGbvVisitAction.Status computedStatus() {
    ...
    public interface SbcVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseGbvVisitAction baseGbvVisitAction);
    }
    ...
    public static class Builder {
        ...
        public BaseGbvVisitAction build() throws ValidationException {
            return new BaseGbvVisitAction(this);
        }
    }
