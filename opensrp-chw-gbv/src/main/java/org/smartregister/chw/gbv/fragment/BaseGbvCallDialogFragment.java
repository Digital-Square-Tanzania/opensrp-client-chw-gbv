...
import org.smartregister.chw.gbv.listener.BaseGbvCallWidgetDialogListener;

public class BaseGbvCallDialogFragment extends DialogFragment implements BaseGbvCallDialogContract.View {
    ...
    public static BaseGbvCallDialogFragment launchDialog(Activity activity, MemberObject MO) {
        BaseGbvCallDialogFragment dialogFragment = BaseGbvCallDialogFragment.newInstance();
    ...
    public static BaseGbvCallDialogFragment newInstance() {
        return new BaseGbvCallDialogFragment();
    }
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        setUpPosition();
        if (listener == null) {
            listener = new BaseGbvCallWidgetDialogListener(this);
        }
    ...
    @Override
    public void setPendingCallRequest(BaseGbvCallDialogContract.Dialer dialer) {
