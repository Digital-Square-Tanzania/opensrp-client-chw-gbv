...
public class BaseGbvRegisterActivity extends BaseRegisterActivity implements GbvRegisterContract.View {
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof BaseGbvRegisterFragment) {
    ...
    public void startFormActivity(JSONObject jsonForm) {
        Intent intent = new Intent(this, BaseGbvRegisterActivity.class);
    ...
    protected void registerBottomNavigation() {
        ...
        if (bottomNavigationView != null) {
            ...
            BottomNavigationListener familyBottomNavigationListener = new GbvBottomNavigationListener(this);
    ...
    protected void initializePresenter() {
        presenter = new BaseGbvRegisterPresenter(this, new BaseGbvRegisterModel(), new BaseGbvRegisterInteractor());
    }
    ...
    @Override
    public GbvRegisterContract.Presenter presenter() {
        return (GbvRegisterContract.Presenter) presenter;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK && requestCode == Constants.REQUEST_CODE_GET_JSON) {
            ...
            try {
                ...
                JSONArray fieldsOne = GbvJsonFormUtils.fields(form, Constants.STEP_ONE);
    ...
    public void startClientProcessing() {
        try {
            ...
            GbvUtil.getClientProcessorForJava().processClient(GbvUtil.getSyncHelper().getEvents(lastSyncDate, BaseRepository.TYPE_Unprocessed));
