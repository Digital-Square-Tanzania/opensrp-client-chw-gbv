...
public class GbvJsonFormUtils extends org.smartregister.util.JsonFormUtils {
    ...
    protected static FormTag formTag(AllSharedPreferences allSharedPreferences) {
        ...
        formTag.appVersion = GbvLibrary.getInstance().getApplicationVersion();
        formTag.databaseVersion = GbvLibrary.getInstance().getDatabaseVersion();
        return formTag;
    }
    ...
    public static void tagEvent(AllSharedPreferences allSharedPreferences, Event event) {
        ...
        event.setClientApplicationVersion(GbvLibrary.getInstance().getApplicationVersion());
        event.setClientDatabaseVersion(GbvLibrary.getInstance().getDatabaseVersion());
    }
    ...
    public static JSONObject getFormAsJson(String formName) throws Exception {
        return FormUtils.getInstance(GbvLibrary.getInstance().context().applicationContext()).getFormJson(formName);
    }
