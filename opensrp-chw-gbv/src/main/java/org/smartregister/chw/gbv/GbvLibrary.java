package org.smartregister.chw.gbv;
...
public class GbvLibrary {
    private static GbvLibrary instance;
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new GbvLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static GbvLibrary getInstance() {
        if (instance == null) {
    ...
    private GbvLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
