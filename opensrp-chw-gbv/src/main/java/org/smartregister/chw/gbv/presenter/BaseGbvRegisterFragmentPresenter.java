...
public class BaseGbvRegisterFragmentPresenter implements GbvRegisterFragmentContract.Presenter {
    ...
    protected WeakReference<GbvRegisterFragmentContract.View> viewReference;
    ...
    public BaseGbvRegisterFragmentPresenter(GbvRegisterFragmentContract.View view, GbvRegisterFragmentContract.Model model, String viewConfigurationIdentifier) {
    ...
    protected GbvRegisterFragmentContract.View getView() {
