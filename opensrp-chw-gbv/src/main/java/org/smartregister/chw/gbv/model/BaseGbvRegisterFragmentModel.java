...
public class BaseGbvRegisterFragmentModel implements GbvRegisterFragmentContract.Model {

    @Override
    public RegisterConfiguration defaultRegisterConfiguration() {
        return ConfigHelper.defaultRegisterConfiguration(GbvLibrary.getInstance().context().applicationContext());
    }
