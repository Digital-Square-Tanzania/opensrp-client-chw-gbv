...
public class LinkageActionHelper extends GbvVisitActionHelper {
    private MemberObject memberObject;

    private String wasTheClientLinkedToOtherServices;

    private JSONObject jsonForm;


    public LinkageActionHelper(MemberObject memberObject) {
    ...
    public void onPayloadReceived(String jsonPayload) {
        ...
        try {
            ...
            wasTheClientLinkedToOtherServices = JsonFormUtils.getValue(payload, "was_the_client_linked_to_other_services");
        } catch (JSONException e) {
            Timber.d(e);
        }
    }
    ...
    public BaseGbvVisitAction.Status evaluateStatusOnPayload() {
        if (StringUtils.isNotBlank(wasTheClientLinkedToOtherServices)) {
