...
public class BaseGbvProfileActivityTest {
    @Mock
    public BaseGbvProfileActivity baseTestProfileActivity;

    @Mock
    public GbvProfileContract.Presenter profilePresenter;
    ...
    public void formatTime() {
        BaseGbvProfileActivity activity = new BaseGbvProfileActivity();
        try {
    ...
    public void onClickBackPressed() {
        baseTestProfileActivity = Mockito.spy(new BaseGbvProfileActivity());
