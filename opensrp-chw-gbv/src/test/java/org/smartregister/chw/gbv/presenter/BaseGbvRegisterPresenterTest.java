...
@PrepareForTest(BaseGbvRegisterPresenter.class)
public class BaseGbvRegisterPresenterTest {
    @Mock
    protected BaseGbvRegisterPresenter baseGbvRegisterPresenter;

    @Mock
    protected GbvRegisterContract.Interactor interactor;
    @Mock
    protected GbvRegisterContract.Model model;
    @Mock
    protected GbvRegisterContract.View baseView;
    private BaseGbvRegisterPresenter presenter;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        presenter = new BaseGbvRegisterPresenter(baseView, model, interactor);
    }
    ...
    public void getViewWhenViewIsNull() throws Exception {
        Assert.assertNull(Whitebox.invokeMethod(baseGbvRegisterPresenter, "getView"));
    }
