...
@PrepareForTest(BaseGbvCallDialogFragment.class)
public class BaseGbvCallDialogFragmentTest {
    @Spy
    public BaseGbvCallDialogFragment baseTestCallDialogFragment;
    ...
    public void setUp() {
        ...
        Whitebox.setInternalState(BaseGbvCallDialogFragment.class, "MEMBER_OBJECT", memberObject);
    }
