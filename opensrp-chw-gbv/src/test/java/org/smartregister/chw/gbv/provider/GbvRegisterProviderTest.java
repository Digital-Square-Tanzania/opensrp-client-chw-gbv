...
public class GbvRegisterProviderTest {
    @Mock
    public CommonPersonObjectClient commonPersonObjectClient;
    @Mock
    public View.OnClickListener listener;
    @Mock
    public GbvRegisterProvider.RegisterViewHolder viewHolder;
    @Mock
    private GbvRegisterProvider testRegisterProvider;
    ...
    public void updateMemberGender() throws Exception {
        ...
        GbvRegisterProvider provider = new GbvRegisterProvider(activity, listener, listener, null);
